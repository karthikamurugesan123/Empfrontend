...
export default function UserTable() {
    ...
    const handleUserDelet = async () => {
        try {
            const DeletUser = await axios.delete(`https://empbackend-o6q9.onrender.com/api/delete/${userId}`)
    ...
    const handleOnSubmit = async (e) => {
        ...
        try {
            const UpdatedUser = await axios.put(`https://empbackend-o6q9.onrender.com/api/update/${updatedUserId}`,value)
